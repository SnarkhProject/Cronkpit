        ...
        public override void Update_Monster(Player pl, Floor fl)
        {
            ...
            if (can_see_player)
            {
                ...
                if (my_weapon_type == Grendel_Weapon_Type.Frostbolt)
                {
                    ...
                    {
                        fl.create_new_projectile(new Projectile(my_grid_coord, last_seen_player_at, Projectile.projectile_type.Flamebolt, ref cont));
                        fl.addmsg("The Grendel attacks you!");
                        fl.add_effect(Attack.Damage.Fire, pl.get_my_grid_C());
